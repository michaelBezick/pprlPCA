...
HYDRA_FULL_ERROR=1 CUDA_VISIBLE_DEVICES=2 python ./scripts/maniskill_train_sac.py parallel=False env=turn_faucet model=ppt platform=debug batch_B=1 runner.n_steps=1 eval.n_eval_envs=1 eval.max_trajectories=1
